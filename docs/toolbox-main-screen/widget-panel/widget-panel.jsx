...
function WidgetPanel() {
  ...
  const [ampmPart, setAmpmPart] = useState('');
    ...
    <div className="widget-panel">
      <div className="widget-panel-grid">
        <div className="time-card">
          <p className="time-card-text"><span>{timePart}</span><span className="time-sub-text">{ampmPart}</span></p>
          <p className="day-text">{currentDate}</p>
